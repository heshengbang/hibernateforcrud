package com.hsb.hibernate.entity;/*
...
public class Employee {
    ...
    public Employee(Long empId, String empNo, String empName, String job, Employee manager, Date hideDate, Float salary, Department department) {
        this.empId = empId;
        this.empNo = empNo;
